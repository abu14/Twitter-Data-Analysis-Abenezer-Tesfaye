...
sampletweetsjsonfile = "tests\test_df_twitter.json"   #put here the path to where you placed the file e.g. ./sampletweets.json. 
...
class TestTweetDfExtractor(unittest.TestCase):
    ...
    def test_find_is_sensitive(self):
        self.assertEqual(self.df.is_sensitive(), ['nan', 0.0, 0.0, 0.0, 0.0])
